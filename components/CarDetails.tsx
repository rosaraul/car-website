        ...
        <Transition appear show={isOpen} as={Fragment}>
            <Dialog as="div" className="relative z-10" onClose={closeModal}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center"><Transition.Child
                        as={Fragment}
                        enter="ease-out duration-300"
                    ...
                    >
                        ...
                        overflow-y-auto trnasmform rounded-2xl bg-white p-6 text-left shadow-xl
                        transition-all flex-col gap-5">
                            <button
                                ...
                                onClick={closeModal}
                            >
                                <Image src="/close.svg" alt="svg" width={20} height={20} className="object-contain" />
